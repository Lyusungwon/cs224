...
class SoftmaxModel(Model):
    ...
    def add_placeholders(self):
        ...
        self.output_placeholder = tf.placeholder(tf.float32, shape=(64, 5))    
    ...
    def add_prediction_op(self):
        ...
        """
        ### YOUR CODE HERE
        W = tf.Variable(tf.zeros([100, 5], tf.float32))
        b = tf.Variable(tf.zeros([5], tf.float32))
        pred = softmax(tf.matmul(self.input_placeholder, W) + b)
        # tf.Variables(input_data)
